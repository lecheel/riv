...
use crate::rounded_box::{catppuccin, clear_rect, draw_bottom_border, draw_row_text, draw_top_border, BoxStyle, RowStyle};
...
pub fn render_register_popup(
    ...
    let max_height = if is_registers { 10usize } else { edit_height / 2 };
